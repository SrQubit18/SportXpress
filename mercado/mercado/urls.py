...
urlpatterns = [
    ...
    path('estado_cuenta/fecha', views.estado_cuenta_por_fecha, name='estado_cuenta_por_fecha'),
    path('estado_cuenta/cliente', views.estado_cuenta_por_cliente, name='estado_cuenta_por_cliente'),
    ...
    path('accounts/profile/',views.account_manage,name="account"),
